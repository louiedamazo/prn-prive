...
export default function ModeloClient({
  ...
  const bannerUrl = banner_id
    ? `https://drive.google.com/thumbnail?id=${banner_id}&sz=w1600`
    : null;
    ...
    <div style={{ background: "#0e0e0e", minHeight: "100vh", position: "relative" }}>
      ...
      <div style={{ position: "absolute", top: 20, left: 32, zIndex: 10 }}>
        <button
          ...
          style={{
            ...
            cursor: "pointer",
            opacity: 0.6,
            filter: "drop-shadow(0 0 0px #b08d57)",
            transition: "opacity 0.3s, filter 0.3s",
          }}
          onMouseEnter={(e) => {
            e.currentTarget.style.opacity = "1";
            e.currentTarget.style.filter = "drop-shadow(0 0 6px #b08d57)";
          }}
          onMouseLeave={(e) => {
            e.currentTarget.style.opacity = "0.6";
            e.currentTarget.style.filter = "drop-shadow(0 0 0px #b08d57)";
          }}
        >
          <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
            <path d="M14 4L7 11L14 18" stroke="#b08d57" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
        </button>
      </div>
        ...
        >
          ...
          <div
            style={{
              ...
              inset: 0,
              pointerEvents: "none",
              background: "linear-gradient(to right, #0e0e0e 0%, rgba(14,14,14,0.7) 8%, transparent 25%)",
            }}
          />
          <div
            style={{
              ...
              inset: 0,
              pointerEvents: "none",
              background: "linear-gradient(to left, #0e0e0e 0%, rgba(14,14,14,0.7) 8%, transparent 25%)",
            }}
          />
        </div>
      )}
              ...
              {paged.map((v) => (
                <div key={v.id} className="thumb-card" style={{ cursor: "pointer" }}>
                  ...
                  >
                    ...
                    <img
                      src={`https://drive.google.com/thumbnail?id=${v.thumb_id}&sz=w800`}
                      alt={v.titulo}
                      style={{
                        position: "absolute",
                        inset: 0,
      ...
      {activeVideo && (
        ...
        >
          ...
          >
            <iframe
              src={`https://drive.google.com/file/d/${activeVideo.video_id}/preview?autoplay=1`}
  ...
  return (
    <button
      ...
      style={{
        ...
        height: 32,
        borderRadius: 7,
        border: active ? "1px solid #e81e5e" : "1px solid rgba(255,255,255,0.12)",
        background: active ? "#e81e5e" : "rgba(255,255,255,0.05)",
        color: active ? "#fff" : disabled ? "#444" : "#ccc",
        fontSize: 13,
